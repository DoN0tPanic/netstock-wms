...
Come si è arrivati al fornitore è scritto accanto a ogni riga — `partita IVA`, `intestazione`, `assegnato a mano` — perché un riconoscimento senza il suo perché costringe a controllarli tutti o a fidarsi di tutti. Il fornitore si cambia dalla scheda, e **si crea dalla stessa tendina** («+ Crea un fornitore…»): è davanti a una bolla che non si sa dove mettere che ci si accorge che manca, ed è lì che lo si cerca — mandare in un'altra sezione vuol dire tornare senza ricordarsi qual era la bolla. Creato così, quella bolla gli viene assegnata subito. Chi preferisce prepararli in anticipo ha «Anagrafica fornitori» accanto ai gruppi, che porta alla scheda completa (anche in **Magazzino → Fornitori**). Appena creato, le bolle mai riconosciute vengono ripassate con l'anagrafica nuova — se ne nominano una, ci finiscono da sole. Lo stesso lo fa «Riconosci di nuovo» a comando.
