...
export function ReceiveForm({ onSuccess }: { onSuccess: (createdUnits: number) => void }) {
  ...
  // Una ricezione ripetuta dopo una risposta persa non deve registrare due carichi.
  const operazione = useChiaveOperazione();
