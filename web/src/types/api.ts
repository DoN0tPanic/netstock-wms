...
export interface DeliveryNoteLine { id: UUID; delivery_note_id: UUID; line_number: number; catalog_item_id: UUID; qty_expected: Decimal; qty_received: Decimal; condition: ItemCondition; notes: string | null; part_number: string | null; catalog_item_name: string | null }
