...
// Il tipo di documento in italiano, negli stessi termini sia in elenco che
// nell'editor: in tabella compariva il valore grezzo dell'enum
// («device_label»), cioè proprio il gergo che rendeva questa sezione
// indecifrabile.
const DOCUMENTO: Record<TemplateDocType, string> = { device_label: "Etichetta dispositivo", box_label: "Etichetta scatola", delivery_note: "Bolla", packing_list: "Packing list" };
...
export function TemplatesAdmin() {
  ...
  return (
    <Page
      title="Template IA"
      description="Come il sistema riconosce seriali e modelli nelle foto di etichette e bolle"
      ...
      {query.isLoading ? (
        ...
        <Table
          ...
          columns={[
            ...
            { key: "type", label: "Documento", render: (row) => DOCUMENTO[row.doc_type] ?? row.doc_type },
